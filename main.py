...
def special(char_name, char_class) -> str:
    """Функция добавления умений персонажу."""
    if char_class == 'warrior':
        text = 'применил специальное умение «Выносливость'
        return (f'{char_name} {text} {80 + 25}»')
    if char_class == 'mage':
        text = 'применил специальное умение «Атака'
        return (f'{char_name}  {text}  {5 + 40}»')
    if char_class == 'healer':
        text = 'применил специальное умение «Защита'
        return (f'{char_name}  {text}  {10 + 30}»')

    return 'Error'


def start_training(char_name, char_class) -> str:
    """Функция для тренировки выбранного персонажа."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция для ввода названия персонажа."""
    approve_choice = None
    char_class = ''
